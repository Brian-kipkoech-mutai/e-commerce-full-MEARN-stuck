...
function CardContainer(props) {
  return (
    <div className=" border shadow-lg  w-[45%]  md:min-w-56 max-w-60 rounded-md flex-shrink-0 cursor-pointer group ">
      <Link to={"/product/details"}>
        <section className=" relative    rounded-t-md overflow-hidden  ">
          <img
            ...
            srcset=""
            className=" w-full h-full md:min-h-60 object-cover max-h-48 lg:max-h-64"
          />
        ...
        <div className="flex-col gap-3 w-full items-start p-2 mt-2 lg:mt-4   rounded-md space-y-2 ">
